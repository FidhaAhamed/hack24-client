          ...
          <div className="faq-questions">
            <div className="accordion-container">
              ...
              <details>
                ...
                <div className="accordion-content">
                  Dark matter is a form of matter that cannot be seen directly
                  but can be inferred by its influence on galaxy formation and
                  the speed of star rotation. It is believed to make up 27% of
              ...
              <details>
                ...
                <div className="accordion-content">
                  ...
                  to have been a moment when the entire universe rapidly
                  expanded from an infinitely dense and hot point.
                </div>
              </details>
              <details>
                <summary>
                ...
                <div className="accordion-content">
                  Dark energy is a form of energy that cannot be seen directly
                  but can be inferred by its influence on the universe's
                  expansion. It is believed to make up 68% of the total energy
                  of the universe.
                </div>
              </details>
              <details>
