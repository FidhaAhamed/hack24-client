...
export default function Faq() {
    return (
        ...
        <div className="lower-heading"><h2>Have some queries?</h2></div>
        <div className="faq-body">
            ...
            <div className="accordion-container">
              <details open>
                <summary>
                  ...
                  <span className="accordion-icon"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-chevron-down">
          ...
          <div className="faq-img">
            <img src="src\assets\thinking programmer.png" alt="thinking programmer"/>
          </div>
        </div>
      </section>
    );
