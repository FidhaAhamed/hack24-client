...
const PrizePool = () => {
  return (
    <section className="px-3 pt-12 md:px-12 lg:px-32  max-w-[1500px] mx-auto min-h-dvh flex flex-col place-content-center">
      <h1 className="text-sm sm:text-lg text-center text-[#F56E0F] font-semibold">
        Prize Pool
      </h1>
      <h1 className="text-2xl sm:text-4xl text-center text-[#FBFBFB] font-bold">
        Take a Peek at the Prizes
      </h1>
